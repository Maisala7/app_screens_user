   ...
   return Scaffold(
    ...
    child: Column(children: [
      Padding(
        ...
        child: Text(':الرجاء مراعات التنبيهات التاليه لضمان اكمال الاجراءات بنجاح',
        style: TextStyle(
          fontSize: 15,
     ...
     Padding(
       ...
       child: Text("يرجى نقل البيانات من البطاقه القديمه تجنبا من الوقوع في الاخطاء- ",
          style: TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
          ),),
     ...
     Padding(
       padding: const EdgeInsets.only(right:10,top: 20,left: 60 ),
       child: Text(" ادخل بياناتك باللغه العربيه فقط اما الارقام ادخلها  باللغه الانجليزيه- ",
          style: TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
          ),),
     ...
     Padding(
       padding: const EdgeInsets.only(right:10,top: 20,left: 60 ),
       child: Text(" سيتم اشعارك بتاريخ اكمالك للاجراءات في مجمع خدمات الجمهور - ",
          style: TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
          ),),
       ...
       child: Text("   سيتم اشعارك عندما تكون  بطاقتك جاهزه للاستلام - ",
          style: TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
          ),),
     ...
     Padding(
       padding: const EdgeInsets.only(right:10,top: 20,left: 90 ),
       child: Text("          لبداية خطوات التجديد اضغط على زر البدايه - ",
          style: TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
          ),),
        ...
        Padding(
       padding: const EdgeInsets.only(right:10,top: 20,left: 90 ),
       child: Text("  لمتابعة حالة بطاقتك اضغط على زر المتابعه- ",
          style: TextStyle(
            fontSize: 13,
            fontWeight: FontWeight.bold,
          ),),
